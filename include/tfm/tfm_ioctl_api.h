...
enum tfm_spu_events {
	TFM_SPU_EVENT_FLASHACCERR = 1 << 0,
	TFM_SPU_EVENT_RAMACCERR = 1 << 1,
...
enum tfm_ns_fault_service_type {
	TFM_NS_FAULT_SERVICE_TYPE_SET_HANDLER = 0,
};

struct tfm_ns_fault_service_args_set_handler {
...
struct tfm_ns_fault_service_args {
	uint32_t type;
	union {
		struct tfm_ns_fault_service_args_set_handler set_handler;
	};
};
