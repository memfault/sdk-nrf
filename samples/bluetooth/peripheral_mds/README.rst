...
The Memfault device ID in this sample is set to the BLE MAC address, but can be overridden with :kconfig:option:`CONFIG_MEMFAULT_NCS_DEVICE_ID` static Kconfig option.
