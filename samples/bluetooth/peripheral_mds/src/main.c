...
static void serial_number_init(void)
{
	...
	if (retval == 0) {
		...
		settings_runtime_set(SERIAL_NUMBER_SETTING_KEY, device_serial, strlen(device_serial));
	}
...
SHELL_STATIC_SUBCMD_SET_CREATE(app_cmds, SHELL_CMD_ARG(set_project_key, NULL,
